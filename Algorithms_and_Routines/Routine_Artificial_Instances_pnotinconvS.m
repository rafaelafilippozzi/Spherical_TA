% Routine for Artificial Instances for the Spherical CHMP with p notin convS
%Choice one
...
%p notin convA
            ...
            tic;
            [Decisionheu,pkheu,a,iterationsheusubpro,info]= SPHERICALTAPLUSHEU(data_mat,p,epsilon,1,1,Extrainformation);
...
for i=1:length(Dim_array)
    ...
    i=1;
    this_title=['$0 \notin conv(\mathcal{S})$, ','$\varepsilon = 10^{-7}$'];
    figure(i);
    hold on
